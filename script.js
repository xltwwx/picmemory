document.addEventListener('DOMContentLoaded', () => {
    ...
    const allImageSources = [
        { src: "img/1.jpg", title: "呆(￣、￣)" },
        { src: "img/2.jpg", title: "圣诞节" },
        { src: "img/3.jpg", title: "打车" },
        { src: "img/4.jpg", title: "看书" },
        { src: "img/5.jpg", title: "认真" },
        { src: "img/元宝猫步.jpg", title: "元宝猫步" },
        { src: "img/帽子金.jpg", title: "帽子金" },
        { src: "img/长发美女.jpg", title: "长发美女" },
        { src: "img/橘子金1.jpg", title: "橘子金1" },
        { src: "img/橘子金2.jpg", title: "橘子金1" },
        { src: "img/橘子金3.jpg", title: "橘子金1" },
        /* 添加自己的图片示例 
        -----------------------------
